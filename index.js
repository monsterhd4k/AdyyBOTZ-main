...
nopref = false
prefa = '👎'
bacaanmenu ='root@FyqqBotz~#' //BUAT FOOTER MENU, GANTI KALO MAU
imgmenu = fs.readFileSync(`./media/fake.jpeg`)
linkmenu = '-'
ownernya = '601151102125@s.whatsapp.net'
ownerNumber = ["601151102125:601151102125@s.whatsapp.net","0@s.whatsapp.net"]
...
const katalog = (teks) => {
             res = conn.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Fyqq_*", "thumbnail": imgmenu, "surface": 'CATALOG' }}, {quoted:fkontak})
...
*Bot Info*
• Script : https://bit.ly/escebotnya
• Prefix : ${prefix}
• Auto recording : true
• Multi Prefix : true
• No Prefix : false
...
const buttonwws = [
  {buttonId: `menu`, buttonText: {displayText: `Menu`}, type: 1}
    ...
    const buttonMessagwwe = {
    	"locationMessage": {
            "name": "FyqqBot",
            "url": "https://telegra.ph/file/3d8b8b90da1eeb436310f.jpg",
            "jpegThumbnail": "https://telegra.ph/file/3d8b8b90da1eeb436310f.jpg"
 },
...
• Uptime : ${waktu(ruan)}
• Script : https://bit.ly/escebotnya
• Group Bot : https://bit.ly/gcbotfiqq
`
...
buttonsMessage = {footerText:'© Fyqqofc', imageMessage: imageMsg,
